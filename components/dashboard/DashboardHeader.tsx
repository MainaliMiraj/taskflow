...
export default function DashboardHeader() {
    ...
    return (
        ...
        {user ? user.name[0].toUpperCase() : "U"}
                            ...
                            {open && (
                                <div
                                    className="absolute mt-24 w-48 bg-white shadow-lg border border-gray-200 z-50 rounded-full"
                            ...
                            <div className="text-left mr-2">
                                <p className="text-sm font-medium text-gray-900" data-testid={'username'}>
                                    {user
                            ...
                            <div onClick={handleLogout} aria-label={'logout'}>
